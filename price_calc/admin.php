...
if (isset($_GET['action']) && isset($_GET['id'])) { //
    ...
    if (!empty($table_name)) {
        ...
        if ($stmt_delete) { //
            ...
            if (!$stmt_delete->execute()) { $error .= "เกิดข้อผิดพลาดในการลบ{$item_type}: " . $stmt_delete->error . "<br>"; } //
            $stmt_delete->close(); //
...
// การแก้ไขข้อมูลจะถูกจัดการผ่าน AJAX และ admin_ajax_data_handler.php
// ------------------------------------------------------------------
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    // --- จัดการการเพิ่มกฎราคา ---
    if (isset($_POST['add_rule'])) { //
        $rule_name = $_POST['add_rule_name']; // ใช้ id จากฟอร์มเพิ่ม
    ...
    // *** ลบส่วนจัดการ $_POST['update_all_rules_in_table'] ออกไปแล้ว ***
            ...
            <div class="table-responsive">
                <table id="rulesTable">
                    ...
                    <tbody>
                        ...
                        <tr id="rule-row-<?php echo $rule['rule_id']; // <-- เพิ่ม ID ตรงนี้ ?>">
            ...
            <div class="table-responsive">
                <table id="materialsTable">
                    ...
                    <tbody>
                        ...
                        <tr id="material-row-<?php echo $mat['material_id']; // <-- เพิ่ม ID ตรงนี้ ?>">
