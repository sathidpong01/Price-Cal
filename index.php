    ...
    <div class="container">
        ...
        <div class="calculators-grid">
            ...
            <div class="calculator-section">
                ...
                <form id="vinylForm">
                    <div><label for="vn_width">ความกว้าง (ซม.):</label><input type="text" id="vn_width" name="vn_width"
                            value=""></div>
                    <div><label for="vn_height">ความสูง (ซม.):</label><input type="text" id="vn_height" name="vn_height"
                            value=""></div>
            ...
            <div class="calculator-section">
                ...
                <form id="letterForm">
                    ...
                    <div><label for="letter_quantity">จำนวนตัวอักษร:</label><input type="text" id="letter_quantity"
                            name="letter_quantity" value=""></div>
            ...
            <div class="calculator-section">
                ...
                <form id="lightboxForm">
                    ...
                    <div><label for="lb_width">ความกว้าง (ซม.):</label><input type="text" id="lb_width" name="lb_width"
